...
// extern item std::map<std::string, ReservedWord> string2reservedWord;
// extern item std::map<Symbol, std::string> symbol2outputString;
// extern item std::map<ReservedWord, Symbol> reservedWord2symbol;
